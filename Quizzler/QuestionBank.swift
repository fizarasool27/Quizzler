...
class QuestionBank {
    ...
    init() {
        ...
        list.append(Question(text: "Entire data of the world can be stored in 4 gms of DNA.", correctAnswer: true))
        
        list.append(Question(text: "Almost 1 million emails are sent per second", correctAnswer: false))
        
        list.append(Question(text: "The world's first camera took 8 hours to snap a picture", correctAnswer: true))
